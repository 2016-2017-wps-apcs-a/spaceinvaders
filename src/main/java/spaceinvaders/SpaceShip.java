...
public class SpaceShip extends Sprite {
    ...
    public SpaceShip() {
        ...
        add(new FilledPolygon(new Color(100, 30, 10), new int[] { 51, 149, 149, 51, }, new int[] { 65, 65, 130, 130, })); //15
        ...
        add(new FilledPolygon(Color.GRAY, new int[] { 95, 105, 105, 95, }, new int[] { 0, 0, 60, 60, })); //3
        /*
