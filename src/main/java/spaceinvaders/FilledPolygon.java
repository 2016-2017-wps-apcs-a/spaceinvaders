...
/*
    public FilledPolygon(Color color, int x, int y, int width, int height) {
        this(color,
            new int[] { x, x + width - 1, x + width - 1, x },
...
/*
    public int getX() { return this.xpoints[0]; }
    public int getY() { return this.ypoints[0]; }
    public int getWidth() { return xpoints[1] - xpoints[0] + 1; }
    public int getHeight() { return ypoints[2] - ypoints[1] + 1; }
*/
